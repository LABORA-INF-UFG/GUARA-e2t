...
import (
	...
	e2smkpmies "github.com/LABORA-INF-UFG/GUARA-e2-sm/servicemodels/legacy/e2sm_kpm_v2_go/v2/e2sm-kpm-v2-go"
	e2smrcpreies "github.com/LABORA-INF-UFG/GUARA-e2-sm/servicemodels/legacy/e2sm_rc_pre_go/v2/e2sm-rc-pre-v2-go"
